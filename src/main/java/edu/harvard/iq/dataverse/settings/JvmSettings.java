...
public enum JvmSettings {
    ...
    INDEX_SERVICE(SCOPE_SEARCH, "index-service"),
    SCOPE_MEILISEARCH(SCOPE_SEARCH, "meilisearch"),
    MEILISEARCH_URL(SCOPE_MEILISEARCH, "url"),
    MEILISEARCH_API_KEY(SCOPE_MEILISEARCH, "api-key"),
    MEILISEARCH_INDEX(SCOPE_MEILISEARCH, "index"),
    MEILISEARCH_CANDIDATE_LIMIT(SCOPE_MEILISEARCH, "candidate-limit"),
    MEILISEARCH_EMBEDDER(SCOPE_MEILISEARCH, "embedder"),
    MEILISEARCH_EMBEDDER_MODEL(SCOPE_MEILISEARCH, "embedder-model"),
    MEILISEARCH_EMBEDDER_URL(SCOPE_MEILISEARCH, "embedder-url"),
    MEILISEARCH_EMBEDDER_DIMENSIONS(SCOPE_MEILISEARCH, "embedder-dimensions"),
    MEILISEARCH_SEMANTIC_RATIO(SCOPE_MEILISEARCH, "semantic-ratio"),
    MEILISEARCH_BATCH_SIZE(SCOPE_MEILISEARCH, "batch-size"),
    MEILISEARCH_CONNECT_TIMEOUT_SECONDS(SCOPE_MEILISEARCH, "connect-timeout-seconds"),
    MEILISEARCH_REQUEST_TIMEOUT_SECONDS(SCOPE_MEILISEARCH, "request-timeout-seconds"),
    MEILISEARCH_TASK_TIMEOUT_SECONDS(SCOPE_MEILISEARCH, "task-timeout-seconds"),
